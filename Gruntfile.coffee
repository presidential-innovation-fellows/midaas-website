      ...
      compile: {
        files: {
          'dist/assets/js/midaas-app.js': [
            'src/assets/coffee/data-requester/abstract.coffee'
            'src/assets/coffee/data-requester/income-quantiles-compare.coffee'
            'src/assets/coffee/data-requester/income-quantile-ratio.coffee'
            'src/assets/coffee/data-requester.coffee'
